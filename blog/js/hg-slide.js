      ...
      <div class="nb3-slider-wrapper">
        ...
        <a href="./story1.html" class="nb3-product-slide">
          <div class="case-media">
            <img class="case-img" src="./img/story-2.jpg" alt="소상공인 정책자금 후기 썸네일 - 음식점 운영자">
        ...
        <!-- 카드 2 -->
        <a href="./story2.html" class="nb3-product-slide">
          <div class="case-media">
            <img class="case-img" src="./img/story-3.jpg" alt="소상공인 정책자금 후기 썸네일 - 카페 운영자">
