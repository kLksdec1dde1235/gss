...
function form_c() {
  ...
  function enableButton() {
    $('#send_message').css({ transition: "1s", background: "#13b5a3", color: "#fff" });
  ...
  if (!time) return disableButton("상담 시간 선택을 확인하세요");
  ...
  $(function(){
  $('#name,#phone, .intro_select, .intro_select1,.intro_select2, .intro_select3, .intro_select4,.intro_select5,.intro_select6,#location,  #message,#time_c,#agree11').bind("keyup click change",form_c);
